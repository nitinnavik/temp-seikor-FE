export const LOGIN_ENDPOINT = "api/signin";
...
export const RETRIEVE_PASSWORD = "api/resetPassword";
export const NEW_PASSWORD = "api/changePassword";
export const UPDATE_RESUME = "api/profile/updateResume";
export const ADD_SKILLS = "api/candidate/addSkills";
export const DOWNLOAD_FILE = "api/core/download";
...
export const ADD_RECOMMENDATION = "api/jobs/addRecommendation";
...
export const ADD_BASIC_DETAILS_ENDPOINT = "api/candidate/addBasicDetails";
export const UPDATE_CANDIDATE_NAME = "api/candidate/updateName";
...
export const CHANGE_PASSWORD = "api/candidateChangePassword";
...
// export const GET_USER_ACCOUTDETAILS_ENDPOINT="api/referrer/getUserAccountDetails"
