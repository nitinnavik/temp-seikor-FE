            ...
            <div className="mt-5">
              ...
              <div className="w-100 d-flex gap-3 justify-content-center">
                <input
                  ...
                  // defaultValue={
                  //   candidateDetails?.userJobPreferences?.minExperience
                  //     ? candidateDetails?.userJobPreferences?.minExperience
                  //     : ""
                  // }
                  value={minExperience}
                ...
                <input
                  ...
                  // defaultValue={
                  //   candidateDetails?.userJobPreferences?.maxExperience
                  //     ? candidateDetails?.userJobPreferences?.maxExperience
                  //     : ""
                  // }
                  value={maxExperience}
...
export default JobPreferenceExperience;
