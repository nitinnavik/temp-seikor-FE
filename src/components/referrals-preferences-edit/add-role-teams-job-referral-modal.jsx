...
const AddRoleTeamsJobReferralModal = ({
  setPreferedRoles,
  setPreferedTeams,
}) => {
  ...
  useEffect(() => {
    setRoleOutput(candidateDetails?.refereePreferencesResponse?.preferedRoles);
    setSelectTeams(candidateDetails?.refereePreferencesResponse?.preferedTeams);
  ...
  return (
    <div className="job-preferences-full-height h-100 pb-5">
        ...
        <div className="job-preference-dialog-content">
          <div className=" my-5 d-flex justify-content-center align-content-center ">
            <div>
              ...
              Select functions you want to refer for
              </div>
              <div className="d-flex justify-content-center flex-wrap gap-3 mt-4">
                {teamsStatic.map((team, index) => {
                if(team.masterValue==="Analytics" || team.masterValue==="Design" || team.masterValue==="Sales" || team.masterValue==="Operations" || team.masterValue==="Marketing" ) { 
                  return (
                    <div
                      key={index}
                      className={
              ...
              <div className="large-text-dark my-4">
                Select roles you want to refer for
              </div>
              <div className="d-flex justify-content-center flex-wrap gap-3 mt-4">
...
export default AddRoleTeamsJobReferralModal;
